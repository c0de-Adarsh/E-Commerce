...
function Cart({cart,handleDecrease,handleIncrease,removeHandler, totalProductPrice,applyPromoCode,promocode,setPromoCode,invalid}) {
  ...
  return (
...

    {
      ...
      !cart.length?<EmptyCart/>:      <div className="w-[90%] mx-auto mt-[80px] ">
            ...
            cart.map((cartItem)=>(
              ...
              <div className="flex w-2/5"> 
                ...
                <div className="flex flex-col justify-between ml-4 flex-grow">
                  ...
                  <a href="#" className="font-semibold hover:text-red-500 text-gray-500 text-xs" onClick={()=> removeHandler(cartItem.id)}>Remove</a>
                </div>
              </div>
              <div className="flex justify-center w-1/5">
                {/* <svg className="fill-current text-gray-600 w-3" viewBox="0 0 448 512"><path d="M416 208H32c-17.67 0-32 14.33-32 32v32c0 17.67 14.33 32 32 32h384c17.67 0 32-14.33 32-32v-32c0-17.67-14.33-32-32-32z"/>
                </svg> */}
                <button  className='border px-2 py-1'  onClick={()=>handleDecrease(cartItem.id)}>-</button>
                <button className='px-2'>{cartItem.quantity}</button>
                 <button className='border px-2 py-1' onClick={()=>handleIncrease(cartItem.id)}>+</button>
